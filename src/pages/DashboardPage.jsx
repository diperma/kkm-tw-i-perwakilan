        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              {/* Connection status */}
              <div
                className={`hidden sm:flex items-center space-x-1.5 text-xs font-medium px-2.5 py-1 rounded-full ${
                  usingFallback
        ...
        <div className="flex flex-col md:flex-row justify-between items-center bg-white p-4 rounded-xl shadow-sm border border-slate-200 mb-6 gap-4">
          <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 w-full md:w-auto">
            ...
            <div className="flex items-center space-x-2 w-full sm:w-auto">
              ...
              <select
                className="block w-full sm:w-48 pl-3 pr-8 py-2 text-base border-slate-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-lg bg-slate-50 border transition-colors"
          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-slate-200 animate-fade-in">
            <div className="mb-6 border-b border-slate-200 pb-4">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-2 gap-2">
                ...
                <span
                  className={`flex items-center text-xs sm:text-sm px-3 py-1.5 rounded-full font-bold border ${
                    logsFallback
            ...
            <div className="relative border-l-2 border-slate-200 ml-4 md:ml-6 space-y-8 pb-4">
              {activityLogs.map((log) => {
                ...
                if (log.action === "rename") {
                  ...
                  actionText = "mengubah nama file";
                } else if (log.action === "delete") {
                  Icon = Trash2;
                  iconBg = "bg-red-100";
                  iconColor = "text-red-600";
                  actionText = "menghapus file";
                } else if (log.action === "create_folder") {
                  Icon = FolderOpen;
                  iconBg = "bg-indigo-100";
                  iconColor = "text-indigo-600";
                  actionText = "membuat folder baru";
                }

                return (
                  <div key={log.id} className="relative pl-8 md:pl-10">
                    <div
                      className={`absolute -left-[17px] top-1 w-8 h-8 rounded-full ${iconBg} border-4 border-white flex items-center justify-center shadow-sm`}
                    >
